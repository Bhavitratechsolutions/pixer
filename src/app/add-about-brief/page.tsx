...
//         setPrevImg(null);
//         setImage(null); // Optional: clear the file state if needed
//     };
...
//                                                             <input className="form-control" type="file" name="file"  hidden onChange={handleImageChange} /> <label htmlFor="img" style={{ cursor: 'pointer' }}>
//                                                                 Upload Image
//                                                             </label>
//                                                         </div>
//                                                     </label>
...
//                                                             <button type="button" onClick={handleRemoveImage} className="btn btn-outline-primary" style={{ padding: '.25rem .5rem', fontSize: '.75rem', margin: '10px' }}> Remove </button>
//                                                         </>
