...
//             setPrevImg(`/images/${response.data.about_image}`);
...
//             // const res = await fetch(`/api/about-brief/${id}`, {
//             //     method: 'PUT',
//             //     body: data
//             // });
...
//                                                         <CKEditor data={description} editor={ClassicEditor} onChange={handleChange} />
//                                                     </div>
//                                                 </div>
//                                             </div>
//                                         </div>
