                    ...
                    <div className="h-100 overflow-auto p-4" id="sidebar-scroller" data-overlayscrollbars-initialize>
                        ...
                        <ul className="menu">
                            ...
                            <li className="menu-item has-menu-sub">
                                ...
                                <ul className="menu-sub">
                                    <li className="menu-item">
                                        <Link href="/add-customer" className="menu-link"> Add Customer </Link>
                                    </li>

                                    <li className="menu-item">
                                        <Link href="/customer-list" className="menu-link">   Customer List  </Link>
                                    </li>
                            ...
                            <li className="menu-item has-menu-sub">
                                ...
                                <ul className="menu-sub">
                                    <li className="menu-item">
                                        <Link href="/add-home-slider" className="menu-link"> Add Home Slider </Link>
                                    </li>

                                    <li className="menu-item">
                                        <Link href="/home-slider-list" className="menu-link">   Home Slider List  </Link>
                                    </li>
                            ...
                            <li className="menu-item has-menu-sub">
                                ...
                                <ul className="menu-sub">
                                    <li className="menu-item">
                                        <Link href="/add-testimonial" className="menu-link"> Add Testimonial </Link>
                                    </li>

                                    <li className="menu-item">
                                        <Link href="/testimonial-list" className="menu-link">   Testimonial List  </Link>
                                    </li>
                            ...
                            <li className="menu-item has-menu-sub">
                                ...
                                <ul className="menu-sub">
                                    ...
                                    <li className="menu-item">
                                        <Link href="/banner-list" className="menu-link">Banner List </Link>
                                    </li>
                                </ul>
                            </li>
