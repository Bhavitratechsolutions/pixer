                    ...
                    <div className="container">
                        <div className="d-flex w-100 align-items-center">
                            <div>
                                ...
                                <button type="button" className="sidebar-toggle-btn btn" id="sidebar-toggle-btn" >
                                    <span></span>
                                </button>
                            </div>
                            <div className="w-100">
                                        ...
                                        <div className="position-relative">
                                            ...
                                            <button className="btn header-profile-menu-btn" type="button" id="header-profile-menu-btn">
                                                <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <div>
                                                        <p className="mb-0 text-truncate text-start" style={{ fontSize: '14px' }}><strong>Jhon Doe</strong></p>
                                                        {/* <Link
                                                                    href="/login"
                                            ...
                                            <div className="position-absolute end-0 card header-profile-menu-card shadow mt-3">
                                                <div className="card-header bg-white border-bottom px-2" style={{ '--bs-border-style': 'dashed' } as React.CSSProperties}>
                                                    <div className="d-flex align-items-center bg-gray-1 p-2 rounded-2">
                                                        ...
                                                        <div>
                                                            <p className="mb-0 text-truncate" style={{ fontSize: '14px' }}><strong>Jhon Doe</strong></p>
                                                            <p className="mb-0 text-secondary text-truncate" style={{ fontSize: '13px' }}>Super admin</p>
                                                        </div>
                                                    </div>
                                                </div>
